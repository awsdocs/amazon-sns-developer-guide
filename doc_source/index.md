...
+ [Code examples for Amazon SNS](service_code_examples.md)
   + [Actions for Amazon SNS](service_code_examples_actions.md)
   ...
   + [Scenarios for Amazon SNS](service_code_examples_scenarios.md)
   ...
   + [Cross-service examples for Amazon SNS](service_code_examples_cross-service_examples.md)
