...
| AWS/SNS | NumberOfNotificationsFilteredOut\-MessageAttributes | The number of messages that were rejected by subscription filter policies for attribute\-based filtering\. Units: CountValid Dimensions: Application, PhoneNumber, Platform, and TopicName Valid Statistics: Sum, Average  | 
