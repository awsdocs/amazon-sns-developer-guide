# Amazon SNS document history<a name="sns-document-history"></a>
...
| October 9, 2014 | Added the [Logging Amazon SNS API calls using CloudTrail](sns-logging-using-cloudtrail.md) section\. | 
